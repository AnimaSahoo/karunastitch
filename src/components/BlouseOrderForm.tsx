  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (savedOrder) {
        ...
        if (savedOrder.email) {
          try {
            const shortOrderId = savedOrder.id.slice(0, 8).toUpperCase();
...
<body style="margin:0;padding:0;background-color:#FDF8F3;font-family:'Georgia',serif;">
  <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:40px 36px;border:1px solid rgba(200,81,27,0.15);">
      ...
      <h2 style="color:#6B1A2E;font-size:22px;margin:0 0 12px;">Thank you, ${savedOrder.fullName}!</h2>
      ...
      <div style="background:#FDF8F3;border-radius:12px;padding:24px;margin-bottom:28px;border:1px solid rgba(200,81,27,0.12);">
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr><td style="padding:9px 0;color:#6B5C52;font-size:14px;border-bottom:1px solid rgba(200,81,27,0.1);">Order Date</td><td style="padding:9px 0;color:#1A0A0A;font-size:14px;text-align:right;border-bottom:1px solid rgba(200,81,27,0.1);">${new Date(savedOrder.orderDate).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</td></tr>
          <tr><td style="padding:9px 0;color:#6B5C52;font-size:14px;border-bottom:1px solid rgba(200,81,27,0.1);">Blouse Type</td><td style="padding:9px 0;color:#1A0A0A;font-size:14px;text-align:right;border-bottom:1px solid rgba(200,81,27,0.1);">${savedOrder.blouseType || "Custom Design"}</td></tr>
          <tr><td style="padding:9px 0;color:#6B5C52;font-size:14px;">Expected Delivery</td><td style="padding:9px 0;color:#C8511B;font-size:14px;font-weight:600;text-align:right;">${savedOrder.deliveryDate || "To be confirmed"}</td></tr>
        </table>
      </div>
      <div style="margin-bottom:32px;">
        <h3 style="color:#6B1A2E;font-size:16px;margin:0 0 16px;">What happens next?</h3>
        <div style="padding:12px 0;border-bottom:1px solid rgba(200,81,27,0.08);display:flex;gap:14px;"><div style="width:26px;height:26px;border-radius:50%;background:#F5E6DC;color:#C8511B;font-size:12px;font-weight:700;text-align:center;line-height:26px;flex-shrink:0;">1</div><p style="color:#6B5C52;font-size:14px;line-height:1.6;margin:3px 0 0;">Our team reviews your measurements & design within 24 hours.</p></div>
        <div style="padding:12px 0;border-bottom:1px solid rgba(200,81,27,0.08);display:flex;gap:14px;"><div style="width:26px;height:26px;border-radius:50%;background:#F5E6DC;color:#C8511B;font-size:12px;font-weight:700;text-align:center;line-height:26px;flex-shrink:0;">2</div><p style="color:#6B5C52;font-size:14px;line-height:1.6;margin:3px 0 0;">You may receive a call for any clarifications needed.</p></div>
        <div style="padding:12px 0;border-bottom:1px solid rgba(200,81,27,0.08);display:flex;gap:14px;"><div style="width:26px;height:26px;border-radius:50%;background:#F5E6DC;color:#C8511B;font-size:12px;font-weight:700;text-align:center;line-height:26px;flex-shrink:0;">3</div><p style="color:#6B5C52;font-size:14px;line-height:1.6;margin:3px 0 0;">Your blouse is handcrafted with care — this takes 2–4 weeks.</p></div>
        <div style="padding:12px 0;display:flex;gap:14px;"><div style="width:26px;height:26px;border-radius:50%;background:#F5E6DC;color:#C8511B;font-size:12px;font-weight:700;text-align:center;line-height:26px;flex-shrink:0;">4</div><p style="color:#6B5C52;font-size:14px;line-height:1.6;margin:3px 0 0;">We notify you when your order ships to your US address.</p></div>
      </div>
  ...
  <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:36px;border:1px solid rgba(200,81,27,0.15);">
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;border-bottom:1px solid rgba(200,81,27,0.08);">Name</td><td style="padding:8px 0;color:#1A0A0A;font-size:13px;text-align:right;border-bottom:1px solid rgba(200,81,27,0.08);">${savedOrder.fullName}</td></tr>
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;border-bottom:1px solid rgba(200,81,27,0.08);">Email</td><td style="padding:8px 0;color:#1A0A0A;font-size:13px;text-align:right;border-bottom:1px solid rgba(200,81,27,0.08);">${savedOrder.email}</td></tr>
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;border-bottom:1px solid rgba(200,81,27,0.08);">Phone</td><td style="padding:8px 0;color:#1A0A0A;font-size:13px;text-align:right;border-bottom:1px solid rgba(200,81,27,0.08);">${savedOrder.phone}</td></tr>
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;">Address</td><td style="padding:8px 0;color:#1A0A0A;font-size:13px;text-align:right;">${[savedOrder.street, savedOrder.city, savedOrder.state, savedOrder.zip, savedOrder.country].filter(Boolean).join(", ")}</td></tr>
      </table>
      <h3 style="color:#C8511B;font-size:11px;text-transform:uppercase;letter-spacing:0.1em;margin:0 0 14px;">Order Details</h3>
      <table style="width:100%;border-collapse:collapse;margin-bottom:28px;">
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;border-bottom:1px solid rgba(200,81,27,0.08);">Blouse Type</td><td style="padding:8px 0;color:#C8511B;font-size:13px;font-weight:600;text-align:right;border-bottom:1px solid rgba(200,81,27,0.08);">${savedOrder.blouseType || "Not specified"}</td></tr>
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;border-bottom:1px solid rgba(200,81,27,0.08);">Design</td><td style="padding:8px 0;color:#C8511B;font-size:13px;font-weight:600;text-align:right;border-bottom:1px solid rgba(200,81,27,0.08);">${savedOrder.selectedDesign || "Custom"}</td></tr>
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;border-bottom:1px solid rgba(200,81,27,0.08);">Delivery Date</td><td style="padding:8px 0;color:#1A0A0A;font-size:13px;text-align:right;border-bottom:1px solid rgba(200,81,27,0.08);">${savedOrder.deliveryDate || "Not specified"}</td></tr>
        <tr><td style="padding:8px 0;color:#6B5C52;font-size:13px;">Special Requests</td><td style="padding:8px 0;color:#1A0A0A;font-size:13px;text-align:right;">${savedOrder.specialRequests || "None"}</td></tr>
      </table>
      <div style="text-align:center;">
        <a href="https://karunastitch.lovable.app/admin" style="display:inline-block;background:#6B1A2E;color:#ffffff;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:700;font-size:14px;">Open Admin Dashboard →</a>
      </div>
    </div>
    <div style="text-align:center;margin-top:20px;">
      <p style="color:#6B5C52;font-size:12px;margin:0;">© ${new Date().getFullYear()} KarunaStitch · Stitch with Compassion</p>
    </div>
  </div>
</body>
</html>`;
            ...
            await fetch("https://api.resend.com/emails", {
              ...
              body: JSON.stringify({
                ...
                subject: `✦ New Order #${shortOrderId} – ${savedOrder.fullName}`,
                html: adminEmailHtml,
              }),
            });
